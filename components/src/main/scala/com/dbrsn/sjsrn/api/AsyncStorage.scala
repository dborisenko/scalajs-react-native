...
object AsyncStorage extends js.Object {
  ...
  def mergeItem(key: String, value: String): Promise[Null] = js.native
  ...
  def multiGet(keys: js.Array[String]): Promise[js.Array[js.Array[String]]] = js.native

  def multiRemove(keys: js.Array[String]): Promise[Null] = js.native

  def multiSet(keyValuePairs: js.Array[js.Array[String]]): Promise[Null] = js.native

  def multiMerge(keyValuePairs: js.Array[js.Array[String]]): Promise[Null] = js.native
}
